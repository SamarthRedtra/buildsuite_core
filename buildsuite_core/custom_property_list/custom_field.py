CUSTOM_FIELD = {
	...
	"Stock Entry": [
		...
		# Who the issue is for / against (Supplier, Customer, or Employee).
		{
			"fieldname": "custom_party_type",
			"fieldtype": "Select",
			"label": "Party Type",
			"options": "\nSupplier\nCustomer\nEmployee",
			"insert_after": "custom_cost_code_label",
			"module": "BuildSuite Core",
		},
		{
			...
			"depends_on": "eval:doc.custom_party_type",
			"module": "BuildSuite Core",
		},
		{
	...
	"Material Request": [
		...
		},
		{
			...
			"label": "BuildSuite BOQ",
			"options": "BOQ",
			"insert_after": "custom_party_name",
			"read_only": 1,
			"no_copy": 1,
			"module": "BuildSuite Core",
		},
